...
char returnCharOnTimer()
{
    ...
    //TODO: write this, pass settings and string to show in, loop? use millis()
    //use for testing, return 0 if nothing to display yet
    return 0;
}
//TODO: read characters from serial, take 1 or multiple to display, and pass the rest on
